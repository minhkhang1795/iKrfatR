...
# cv2.drawContours(resized, [cnts[2]], -1, (0, 255, 0), 3)
...
for i in range(10, 70):
    theta = math.pi * i / 180
    lines = cv2.HoughLinesP(edged, 1, theta, 2, 80, 40, 5)
    ...
    if lines is not None and lines[0] is not None:
        for i in range(0, len(lines)):
            ...
            if angle != 90 and angle != -90 and 60 > angle > -60:
                cv2.line(resized, pt1, pt2, (0,0,255), 3)
